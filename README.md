...
<h2 align="center">💻 A passionate <b>Full-Stack Web Developer</b></h2>
...
<p align="center">
  ...
  <!-- Instagram -->
  <a href="https://www.instagram.com/007m_az/" target="_blank">
...
<div align="center">
  <p align="left">
    🔹 <a href="https://www.ocswimorganization.com" target="_blank"><b>OC-Swim</b></a> &mdash; A full-stack Next.js swimming school SaaS platform with:
    ...
    <br>&nbsp;&nbsp;&nbsp;&nbsp;• 🔐 Authentication & authorization with NextAuth + JWT
    <br><br>
    🔹 <a href="https://astraventures.ai/" target="_blank"><b>Astra Venture</b></a> &mdash; A polished marketing site for a venture studio:
    <br>&nbsp;&nbsp;&nbsp;&nbsp;• ⚡ Built with React, Vite, and TypeScript
    <br>&nbsp;&nbsp;&nbsp;&nbsp;• 🎨 Smooth motion design with Framer Motion
    <br>&nbsp;&nbsp;&nbsp;&nbsp;• 📱 Fully responsive layouts
    <br>&nbsp;&nbsp;&nbsp;&nbsp;• 📨 Integrated EmailJS contact pipeline
    <br><br>
    🔹 <b>Multi-Channel Communications Portal</b> <i>(Confidential — Client Project)</i>
    <br>&nbsp;&nbsp;&nbsp;&nbsp;• 📲 Twilio-powered SMS messaging
    <br>&nbsp;&nbsp;&nbsp;&nbsp;• 📧 Bulk email via Mailchimp / Resend
    <br>&nbsp;&nbsp;&nbsp;&nbsp;• 🗂️ CSV imports, contact segmentation, role-based access
    <br>&nbsp;&nbsp;&nbsp;&nbsp;• 🛠️ Next.js + TypeScript + Prisma + MySQL
    <br><br>
